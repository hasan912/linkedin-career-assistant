...
export async function generateText(prompt, { system, maxTokens = 1000 } = {}) {
  ...
  throw new Error(
    "No AI provider configured. Set GEMINI_API_KEY (free, no card needed - https://aistudio.google.com/apikey), " +
    "GROQ_API_KEY (free - https://console.groq.com/keys), or ANTHROPIC_API_KEY in your environment variables."
  );
}
